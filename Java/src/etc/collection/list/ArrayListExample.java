...
import basic.begin.commentsExample;
...
//		string name = nick[3]; (x) 배열
		...
		List<Integer> score = new ArrayList<>(); // 객체 타입 int integer
		score.add(65);
		
		//한번에 객체 많이 추가하기
		Collections.addAll(score, 78,100,28,34,24,74);
