...
//		User kim = new User("길동", 22);
//		User yo = new User("영희", 23);
//		
//		Collections.addAll(user, hong,kim,yo);
		
		List<User> user = new ArrayList<>();
		
		
		user.add(new User("홍길동",20));
		user.add(new User("길동",20));
		user.add(new User("영희",20));
