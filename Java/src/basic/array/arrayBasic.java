...
public class arrayBasic {
	...
	public static void main(String[] args) {
		...
		//배열(array)
		//->같은 데이터 타입의 값을 집합 형태로 나열하기 위한 형태
		
		// 1. 배열 변수의 선언
		int[] arr; // java style
		int arr2[]; // c style
		
		//2. 배열 객체를 생선 -실제 값들이 저장될 공간을 형성
		//생성할 때 배열의 크기를 정해 주셔야 합니다.
		arr = new int[5];
		
		//3. 배열의 초기화 - 배열 내부에 실제 값들을 저장.
		//배열의 초기화는 인덱스를 통해서 수행합니다.
...
//		arr[5] = 77; (x) index 범위를 초과.
		...
		//5.배열의 저장된 값을 참조(사용) 하는법 (인덱스를 이용한다)
		...
		//7.배열 내부의 요소값을 문자열 형태로 한눈에 출력하기.Arrays.to
