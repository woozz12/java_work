...
public class MethodExample {
	...
	//메서드의 선언 (static은 뒤에서 알려드릴게요. 지금 없다라고 생각 하기)
	static int clacTotal(int x) {
		int total = 0;
		for(int i =1; i<=x;i++) {
			total += i;
		}
	...
	public static void main(String[] args) {
		...
		int total = clacTotal(10);
		System.out.println(total);
		System.out.println("1~100까지의 누적합: "+ clacTotal(100));
		System.out.println("1~100까지의 누적합: "+ clacTotal(200));
		System.out.println("1~100까지의 누적합: "+ clacTotal(300));
		System.out.println("1~100까지의 누적합: "+ clacTotal(400));
